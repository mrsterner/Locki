...
public record InventoryLockComponent(int debugMode) {
    ...
    public static final PacketCodec<ByteBuf, InventoryLockComponent> PACKET_CODEC = PacketCodecs.VAR_INT.xmap(InventoryLockComponent::new, InventoryLockComponent::debugMode);
    public static final ComponentType<InventoryLockComponent> TYPE = new ComponentType.Builder<InventoryLockComponent>().codec(CODEC).packetCodec(PACKET_CODEC).build();
